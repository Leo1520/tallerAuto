        ...
        <div class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="ciudad" id="inputCiudad" value="{{ old('ciudad', $sucursal->ciudad) }}"
            ...
            <div>
                ...
                <input type="text" name="direccion" id="inputDireccion" value="{{ old('direccion', $sucursal->direccion) }}"
                       class="w-full px-3 py-2.5 bg-gray-900 border border-gray-600 text-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-600 placeholder-gray-500">
            </div>
    ...
    <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-700">
            <h2 class="text-base font-semibold text-gray-100 flex items-center gap-2">
                ...
                <span class="text-xs font-normal text-gray-500 ml-1">— Haz clic o arrastra el marcador para actualizar</span>
            </h2>
        </div>
        <div class="p-4 space-y-3">
            ...
            <div class="grid grid-cols-2 gap-4 pt-1">
                <div>
                    ...
                    <input type="number" name="latitud" id="inputLat"
                ...
                <div>
                    ...
                    <input type="number" name="longitud" id="inputLng"
            ...
            <p class="text-xs text-gray-600">Haz clic en el mapa, usa el buscador o arrastra el marcador para actualizar las coordenadas.</p>
...
function initMap() {
    ...
    // ── Geolocalización: solo si la sucursal no tiene coordenadas aún ───
    if (!HAS_COORDS && navigator.geolocation) {
