        ...
        <div class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="latitud" value="{{ old('latitud') }}" step="any" min="-90" max="90"
                           class="w-full px-3 py-2.5 bg-gray-900 border border-gray-600 text-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-600 placeholder-gray-500"
                ...
                <div>
                    ...
                    <input type="number" name="longitud" value="{{ old('longitud') }}" step="any" min="-180" max="180"
                           class="w-full px-3 py-2.5 bg-gray-900 border border-gray-600 text-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-600 placeholder-gray-500"
                           placeholder="-68.150000">
                    @error('longitud') <p class="text-red-400 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
            </div>
            <p class="text-xs text-gray-500 -mt-1">Ingresa las coordenadas para mostrar la sucursal en el mapa. Puedes obtenerlas desde Google Maps.</p>
