...
<head>
    ...
    <title>@yield('title', 'Taller Automotrices SC-BOL')</title>
    {{-- Bootstrap 5 CSS --}}
    ...
    <div class="auth-panel" id="auth-left-panel"
        ...
        <div style="position:relative; z-index:1;">
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:52px;">
                ...
                <div>
                    <p style="font-size:20px;font-weight:800;color:var(--a-text);letter-spacing:-.02em;line-height:1.1;">Taller Automotrices SC-BOL</p>
        ...
        {{-- Footer --}}
        <div style="position:relative; z-index:1;">
            <p style="font-size:11px;color:var(--a-dim);">&copy; {{ date('Y') }} Taller Automotrices SC-BOL — Todos los derechos reservados</p>
        </div>
    </div>
